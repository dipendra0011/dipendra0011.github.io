      ...
      <div className="page-figma mx-auto max-w-figma">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3 md:gap-5">
          {cards.map((card, i) => (
            ...
            >
              <p className="font-[family-name:var(--font-instrument)] text-base font-bold uppercase tracking-[0.18em] text-white">
                {card.num}
              </p>
              <h3 className="mt-4 font-[family-name:var(--font-display)] text-[28px] font-bold uppercase leading-7 tracking-[-0.0125em] text-white md:text-[30px]">
                {card.title}
              </h3>
