      ...
      <div className="page-figma mx-auto max-w-figma">
        <div className="flex flex-col gap-14 lg:flex-row lg:gap-16 xl:gap-24">
          <div className="shrink-0 lg:sticky lg:top-28 lg:h-fit lg:w-[320px]">
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2.5rem,5vw,3.75rem)] font-medium uppercase leading-none tracking-[-0.015em] text-white">
              EXPERIENCE
            </h2>
          </div>
          ...
          <ul className="flex flex-1 flex-col gap-0">
            {roles.map((role, i) => (
              ...
              >
                <p className="font-[family-name:var(--font-instrument)] text-[28px] font-bold uppercase leading-8 tracking-[-0.02em] text-white md:text-[30px]">
                  {role.company}
                </p>
                <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                  <div className="max-w-xl space-y-4">
                    <p className="font-[family-name:var(--font-instrument)] text-[22px] font-bold uppercase tracking-[0.0125em] text-white">
                      {role.position}
                    </p>
                  ...
                  <p className="shrink-0 font-[family-name:var(--font-instrument)] text-[22px] font-bold uppercase tracking-[0.0125em] text-white md:text-right">
                    {role.period}
                  </p>
                </div>
              </motion.li>
