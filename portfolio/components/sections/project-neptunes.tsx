...
const tags = ["UX research", "UX ideation", "User interface"] as const;
...
export function ProjectNeptunesPage() {
  return (
    <div className="bg-background">
        ...
        <div className="page-figma mx-auto max-w-figma">
          ...
          >
            ...
            <div className="flex w-full justify-end">
              <button
                type="button"
                className="inline-flex h-10 items-center justify-center border border-white bg-white px-4 font-[family-name:var(--font-display)] text-xs font-semibold uppercase tracking-[0.06em] text-black transition-opacity hover:opacity-90"
                onClick={() =>
                  document
      ...
      {/* Overview / Problem / Solution — Figma 69:603–610 */}
