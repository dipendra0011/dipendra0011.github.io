    ...
    <footer id="footer" className="border-t border-line-grey/80 bg-background pb-16 pt-20 md:pb-24 md:pt-28">
      <div className="page-figma mx-auto flex max-w-figma flex-col gap-16 md:gap-20">
        <div className="flex flex-col gap-12 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
          <div className="font-[family-name:var(--font-display)] text-[clamp(2.5rem,8vw,5.625rem)] font-medium uppercase leading-[0.9] tracking-[-0.023em] text-white">
            <p>Let&apos;s work</p>
            <p className="mt-2 md:mt-4">TOGETHER</p>
          </div>

          <div className="flex max-w-xl flex-col gap-10">
            <p className="font-[family-name:var(--font-display)] text-lg font-medium leading-6 text-white">
            ...
            >
              {social.map((item) => (
                <Link
                  ...
                  className="group inline-flex items-center gap-2 font-[family-name:var(--font-display)] text-lg font-bold uppercase text-white transition-colors hover:text-accent-lime"
                >
                  {item.label}
        ...
        <div className="flex flex-col items-center gap-8 border-t border-line-grey/60 pt-10 md:flex-row md:items-end md:justify-between">
          ...
          <motion.button
            type="button"
            className="flex flex-col items-center gap-3 text-white transition-colors hover:text-accent-lime"
